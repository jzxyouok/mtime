	...
	<div class="container">
		<div class="panel panel-info">
			<div class="panel-heading">
				<p style="font-size:16px;">会员微评论列表</p>
			</div>
			<div class="panel-body">
				<p><span style="color:#31708F;">查看电影的微评论</span></p>
				<form action="/mtime/index.php/Admin/Comment/sortcommentlist" method="get" class="form-horizontal">
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<?php if(is_array($rows)): foreach($rows as $key=>$row): ?><tr>
						...
						<td>
							<?php if($row['comment_status'] == 1): ?><a href="/mtime/index.php/Admin/Comment/updatestatus/id/<?php echo ($row['comment_id']); ?>/p/<?php echo ($p); ?>/mid/<?php echo ($row['comment_mid']); ?>/status/0"><span style="color:green;">审核通过</span></a>
							<?php else: ?>
								<a href="/mtime/index.php/Admin/Comment/updatestatus/id/<?php echo ($row['comment_id']); ?>/p/<?php echo ($p); ?>/mid/<?php echo ($row['comment_mid']); ?>/status/1"><span style="color:red;">未审核</span></a><?php endif; ?>
						</td>
						<td>
							<a href="/mtime/index.php/Admin/Comment/lookcommentreplay/id/<?php echo ($row['comment_id']); ?>/p/<?php echo ($p); ?>">查看评论回复</a>
						</td>
						<td>
							<a href="/mtime/index.php/Admin/Comment/deletesortcomment/id/<?php echo ($row['comment_id']); ?>/p/<?php echo ($p); ?>/mid/<?php echo ($row['comment_mid']); ?>" onclick="javascript:return confirm('你确定删除？');">删除</a>
						</td>
