	...
	<div class="container">
		<div class="panel panel-success">
			<div class="panel-heading">
				<p style="font-size:16px;">添加电影编剧<p>
			</div>
			<div class="panel-body">
				<form action="/mtime/index.php/Admin/Movie/tjeditor" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="form-group">
						<label class="col-md-2">电影名称:</label>
						<div class="col-md-4">
							<select name="filme_mid" class="form-control">
								<option>---请选择---</option>
					...
					<div class="form-group">
						<label class="col-md-2">编剧名称:</label>
						<div class="col-md-4">
							<select name="filme_aid" class="form-control">
								<option>---请选择---</option>
								<?php if(is_array($e)): foreach($e as $key=>$erow): ?><option value="<?php echo ($erow['actor_id']); ?>"><?php echo ($erow['actor_name']); ?></option><?php endforeach; endif; ?>
							</select>
						</div>
					</div>
