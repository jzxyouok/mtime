	...
	<div class="container">
		<div class="panel panel-success">
			<div class="panel-heading">
				<p style="font-size:16px;">添加影院图片<p>
			</div>
			<div class="panel-body">
				<form action="/mtime/index.php/Admin/Cinema/tjpic" method="post" class="form-horizontal" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label class="col-md-2">上传影院图片:</label>
						<div class="col-md-4">
							<input type="file" name="cinemapic_address" class="form-control">
						</div>
					</div>
