	...
	<div class="container">
		<div class="panel panel-info">
			<div class="panel-heading">
				<p style="font-size:16px;">影院图片列表</p>
			</div>
			<div class="panel-body">
				<p><span style="color:#31708F;">查看已添加的影院图片</span></p>
				<form action="/mtime/index.php/Admin/Cinema/piclist" method="get" class="form-horizontal">
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<?php if(is_array($rows)): foreach($rows as $key=>$row): ?><tr>
						<td><?php echo ($row['cinemapic_id']); ?></td>
						<td>
							<img src="/mtime/Public/<?php echo ($row['cinemapic_address']); ?>">
						</td>
						<td>
							<a href="/mtime/index.php/Admin/Cinema/delpic/id/<?php echo ($row['cinemapic_id']); ?>/page/<?php echo ($p); ?>/cid/<?php echo ($row['cinema_cid']); ?>" onclick="javascript:return confirm('你确定删除？');">删除</a>
						</td>
