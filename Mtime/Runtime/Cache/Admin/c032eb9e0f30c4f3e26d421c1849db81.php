	...
	<div class="container">
		<div class="panel panel-info">
			<div class="panel-heading">
				<p style="font-size:16px;">电影幕后列表</p>
			</div>
			<div class="panel-body">
				<p><span style="color:#31708F;">查看电影的幕后揭秘</span></p>
				<form action="/mtime/index.php/Admin/Movie/secretlist" method="get" class="form-horizontal">
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<?php if(is_array($rows)): foreach($rows as $key=>$row): ?><tr>
						<td><?php echo ($row['secret_id']); ?></td>
						<td>
							<?php echo ($row['secret_text']); ?>
						</td>
						<td>
							<a href="/mtime/index.php/Admin/Movie/delsecret/id/<?php echo ($row['secret_id']); ?>/page/<?php echo ($p); ?>/mid/<?php echo ($row['secret_mid']); ?>" onclick="javascript:return confirm('你确定删除？');">删除</a>
						</td>
