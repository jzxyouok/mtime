	...
	<div class="container">
		<div class="panel panel-info">
			<div class="panel-heading">
				<p style="font-size:16px;">电影编剧列表</p>
			</div>
			<div class="panel-body">
				<p><span style="color:#31708F;">查看已添加的电影编剧</span></p>
				<form action="/mtime/index.php/Admin/Movie/editorlist" method="get" class="form-horizontal">
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<?php if(is_array($rows)): foreach($rows as $key=>$row): ?><tr>
						<td><?php echo ($row['filme_id']); ?></td>
						<td><?php echo ($row['actor_name']); ?></td>
						<td>
							<a href="/mtime/index.php/Admin/Movie/deleteeditor/id/<?php echo ($row['filme_id']); ?>/mid/<?php echo ($row['filme_mid']); ?>" onclick="javascript:return confirm('你确定删除？');">删除</a>
						</td>
