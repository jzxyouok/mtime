	...
	<div class="container">
		<div class="panel panel-info">
			<div class="panel-heading">
				<p style="font-size:16px;">电影演员列表</p>
			</div>
			<div class="panel-body">
				<p><span style="color:#31708F;">查看已添加的电影演员</span></p>
				<form action="/mtime/index.php/Admin/Movie/actorlist" method="get" class="form-horizontal">
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<?php if(is_array($rows)): foreach($rows as $key=>$row): ?><tr>
						...
						<td><?php echo ($row['filma_name']); ?></td>
						<td>
							<?php if(empty($row['filma_pic'])): else: ?>
								<img src="/mtime/Public/<?php echo ($row['filma_pic']); ?>"><?php endif; ?>
						</td>
						<td>
							<a href="/mtime/index.php/Admin/Movie/editactor/id/<?php echo ($row['filma_id']); ?>/p/<?php echo ($p); ?>">修改</a>
						</td>
						<td>
							<a href="/mtime/index.php/Admin/Movie/deleteactor/id/<?php echo ($row['filma_id']); ?>/p/<?php echo ($p); ?>/mid/<?php echo ($row['filma_mid']); ?>" onclick="javascript:return confirm('你确定删除？');">删除</a>
						</td>
