	...
	<div class="container">
		<div class="panel panel-success">
			<div class="panel-heading">
				<p style="font-size:16px;">添加电影导演<p>
			</div>
			<div class="panel-body">
				<form action="/mtime/index.php/Admin/Movie/tjdirector" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="form-group">
						<label class="col-md-2">电影名称:</label>
						<div class="col-md-4">
							<select name="filmd_mid" class="form-control">
								<option>---请选择---</option>
					...
					<div class="form-group">
						<label class="col-md-2">导演名称:</label>
						<div class="col-md-4">
							<select name="filmd_aid" class="form-control">
								<option>---请选择---</option>
								<?php if(is_array($d)): foreach($d as $key=>$drow): ?><option value="<?php echo ($drow['actor_id']); ?>"><?php echo ($drow['actor_name']); ?></option><?php endforeach; endif; ?>
							</select>
						</div>
					</div>
