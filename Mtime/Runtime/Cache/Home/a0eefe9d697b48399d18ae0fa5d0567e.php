<?php if (!defined('THINK_PATH')) exit();?><html>
	<head>
		<title><?php echo ($row['movie_name']); ?> <?php echo ($row['video_name']); ?> - Mtime时光网</title>
		<link rel="stylesheet" href="/mtime/Public/Home/css/header.css">
		<link rel="stylesheet" href="/mtime/Public/Home/css/movievideo.css">
	...
	<body>
		<div class="container">
			...
			<div class="db_convideo">
				<div class="db_picposition">
					<p class="px18">
					...
					<span class="pt3 morevideo">
						<i class="icon_piclist"></i>
						<a href="#">查看全部视频</a>
					</span>
				</div>
				
				<div class="db_conpicinner" id="playContent">
					<video src="/mtime/Public/<?php echo ($row['video_address']); ?>" preload width="1000px" height="563px" id="video"></video>
					<div class="playvideo">
						<div class="play"></div>
					</div>
				</div>
	...
	<script>
		...
		$(".playvideo").hover(
			function(){
				$(this).addClass("on");
				$(".play").addClass("playon");
			},
			function(){
				$(this).removeClass("on");
				$(".play").removeClass("playon");
			}
		);
