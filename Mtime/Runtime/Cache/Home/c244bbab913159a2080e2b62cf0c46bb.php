...
<html>
	<head>
		<title><?php echo ($mrow['movie_name']); ?> 剧照 – Mtime时光网</title>
	...
	<link rel="stylesheet" href="/mtime/Public/Home/css/movieposter.css" />
	<script type="text/javascript" src="/mtime/Public/Home/js/picjs/notification.js"></script>
	<script type="text/javascript" src="/mtime/Public/Home/js/picjs/bigimg.js"></script>
	<script type="text/javascript" src="/mtime/Public/Home/js/picjs/jquery.lazyload.min.js" ></script>
	<script type="text/javascript" src="/mtime/Public/Home/js/picjs/blocksit.min.js"></script>
	<script type="text/javascript" src="/mtime/Public/Home/js/picjs/pubu.js"></script>
	

	<link rel="stylesheet" href="/mtime/Public/Home/css/pubu.css" type="text/css" media='screen'/>
	<link rel="stylesheet" href="/mtime/Public/Home/css/bigimg.css" type="text/css" />
		...
		<div class="db_cont">
			<div class="details_nav">
				<ul id="detailSubMenuInDetailPagesRegion">
					...
					<li class="on">
						<i>&nbsp;</i>
						<a href="/mtime/index.php/Home/Moviedetial/movieposter/id/<?php echo ($mrow['movie_id']); ?>">海报</a>
					</li>
					<li class="false">
						<a href="">工作照</a>
					</li>
			...
			<div class="db_pictypeout">
				<div class="pictypenav">
					<ul class="fl mt3">
						<li class="on">
							<a href="/mtime/index.php/Home/Moviedetial/movieposter/id/<?php echo ($mrow['movie_id']); ?>">全部图片</a>
						</li>
					</ul>
				</div>
				<div class="db_pictypelist">
					<div id="wrapper">
						<div id="container" style="width:990px;">
						<?php if(is_array($prow)): $i = 0; $__LIST__ = $prow;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><div class="grid">
								<div class="imgholder">
									<img class="lazy thumb_photo" title="<?php echo ($i); ?>" src="/mtime/Public/Home/images/pixel.gif" data-original="/mtime/Public/<?php echo ($row['pic_address']); ?>" width="220" />
								</div>
