...
<html>
	<head>
		<title><?php echo ($mrow['movie_name']); ?> 剧情 – Mtime时光网</title>
	...
	<link rel="stylesheet" href="/mtime/Public/Home/css/movieabstract.css">
		...
		<div class="db_cont">
			<div class="details_nav">
				<ul id="detailSubMenuInDetailPagesRegion">
					...
					<li class="false">
						<a href="/mtime/index.php/Home/Moviedetial/movieabstract/id/<?php echo ($mrow['movie_id']); ?>">角色介绍</a>
					</li>
					<li>
						<i>&nbsp;</i>
						<a href="/mtime/index.php/Home/Moviedetial/moviesecret/id/<?php echo ($mrow['movie_id']); ?>">幕后揭秘</a>
			...
			<div class="details_cont">
				...
				<div class="plots_out" style="height:960px">
					<div class="plots_tit" id="leftContentRegion"><?php echo ($mrow['movie_ename']); ?></div>
					<?php if(is_array($srow)): $i = 0; $__LIST__ = $srow;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><div class="plots_box">
						<div>
							<p>
