...
<html>
	<head>
		<title><?php echo ($mrow['movie_name']); ?> 幕后揭秘 – Mtime时光网</title>
	...
	<link rel="stylesheet" href="/mtime/Public/Home/css/moviesecret.css">
	...
	<div class="db_contout">
		<div class="db_cont">
			...
			<div class="details_cont">
				<div class="revealed_modle">
					<h4>About</h4>
					<h3>
						关于《<?php echo ($mrow['movie_name']); ?>》你应该知道的
						<b><?php echo ($snum); ?></b>
						件事
					</h3>
					<dl class="revealed_list">
						<?php if(is_array($srow)): $i = 0; $__LIST__ = $srow;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><dd>
